...
class Question(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="question", default=None,
                             verbose_name="用户ID")
...
class Reply(models.Model):
    ...
    type = models.IntegerField(default=0, verbose_name='回答类型')  # 0:评论问题 1:评论回答2: 回答
